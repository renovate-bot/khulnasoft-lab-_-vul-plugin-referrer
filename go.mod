...
require (
	...
	github.com/khulnasoft-lab/vul v0.0.1
...
replace github.com/spdx/tools-golang => github.com/spdx/tools-golang v0.5.5
...
require (
	...
	github.com/khulnasoft-lab/vul-db v0.0.0-20231001154124-3ee1fef0dc41 // indirect
